...
# 2-pass
parser.add_option("-d", "--d", default=64, help="1st layer embedding dimension")
parser.add_option("-l", "--l", default=32, help="2nd layer embedding dimension")
parser.add_option("-k", "--k", default=32, help="The dimension of project metrices k")
